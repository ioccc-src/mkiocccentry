...
chkentry: chkentry.o dbg.o util.o sanity.o utf8_posix_map.o dyn_array.o json_parse.o json_util.o chk_validate.o \
	  entry_util.c json_sem.o foo.o location.o Makefile
	${CC} ${CFLAGS} chkentry.o dbg.o util.o sanity.o utf8_posix_map.o dyn_array.o json_parse.o json_util.o \
...
chkentry.o: chkentry.c chkentry.h dbg.h json_util.h dyn_array.h \
  json_parse.h util.h foo.h sanity.h location.h utf8_posix_map.h \
