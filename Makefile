...
TARGETS= mkiocccentry iocccsize fnamchk txzchk chkentry jstrencode jstrdecode \
	 test/utf8_test jparse verge test/jnum_chk jnum_gen jsemtblgen
...
TEST_TARGETS= dbg/dbg_test test/utf8_test test/dyn_test
OBJFILES= dbg/dbg.o util.o mkiocccentry.o iocccsize.o fnamchk.o txzchk.o chkentry.o \
	...
	dyn_array.o test/dyn_test.o dbg/dbg_test.o test/jnum_chk.o jnum_gen.o test/jnum_test.o \
...
limit_ioccc.sh: limit_ioccc.h version.h dbg/dbg.h dyn_array.h test/dyn_test.h jparse.h jparse_main.h \
		Makefile
	${RM} -f $@
	...
	${GREP} -hE '^#define (.*_VERSION|TIMESTAMP_EPOCH|JSON_PARSING_DIRECTIVE_)' \
		     version.h limit_ioccc.h dbg/dbg.h dyn_array.h test/dyn_test.h jparse.h jparse_main.h | \
	    ${GREP} -v 'UUID_VERSION' | \
...
#
test ioccc_test: test/ioccc_test.sh test/iocccsize_test.sh dbg/dbg_test test/mkiocccentry_test.sh test/jstr_test.sh \
		 test/jnum_chk test/dyn_test test/txzchk_test.sh txzchk jparse Makefile
	${MAKE} chkentry txzchk
...
legacy_clobber:
	...
	${RM} -f ioccc_test.log chkentry_test.log jparse_test.log txzchk_test.log
	${RM} -f jnum_chk
	${RM} -rf jnum_chk.dSYM
	${RM} -rf test_iocccsize test_src test_work
	${RM} -f .exit_code.*
...
sanity.o: sanity.c sanity.h util.h dyn_array.h dbg/dbg.h location.h utf8_posix_map.h limit_ioccc.h \
	version.h
utf8_test.o: test/utf8_test.c test/../utf8_posix_map.h util.h dyn_array.h dbg/dbg.h limit_ioccc.h \
	version.h
...
dyn_test.o: test/dyn_test.c test/dyn_test.h test/../util.h dyn_array.h dbg/dbg.h test/../dbg/dbg.h \
	test/../dyn_array.h
dbg_test.o: dbg/dbg_test.c dbg/dbg.h
jnum_chk.o: test/jnum_chk.c test/jnum_chk.h test/../dbg/dbg.h test/../util.h dyn_array.h dbg/dbg.h \
...
jnum_test.o: test/jnum_test.c test/../json_parse.h util.h dyn_array.h dbg/dbg.h
