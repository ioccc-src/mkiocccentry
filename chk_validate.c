		      ...
		      unsigned int depth, struct json_sem *sem, struct json_sem_val_err **val_err)
{
    ...
    if (test == false) {
	if (val_err != NULL) {
	    *val_err = werr_sem_val(121, node, depth, sem, __func__, "invalid rule_2a_override");
	}
	return false;
    }
		      ...
		      unsigned int depth, struct json_sem *sem, struct json_sem_val_err **val_err)
{
    ...
    if (test == false) {
	if (val_err != NULL) {
	    *val_err = werr_sem_val(122, node, depth, sem, __func__, "invalid rule_2a_mismatch");
	}
	return false;
    }
		      ...
		      unsigned int depth, struct json_sem *sem, struct json_sem_val_err **val_err)
{
    ...
    if (test == false) {
	if (val_err != NULL) {
	    *val_err = werr_sem_val(123, node, depth, sem, __func__, "invalid rule_2b_override");
	}
	return false;
    }
		      ...
		      unsigned int depth, struct json_sem *sem, struct json_sem_val_err **val_err)
{
    ...
    if (test == false) {
	if (val_err != NULL) {
	    *val_err = werr_sem_val(124, node, depth, sem, __func__, "invalid highbit_warning");
	}
	return false;
    }
		      ...
		      unsigned int depth, struct json_sem *sem, struct json_sem_val_err **val_err)
{
    ...
    if (test == false) {
	if (val_err != NULL) {
	    *val_err = werr_sem_val(125, node, depth, sem, __func__, "invalid nul_warning");
	}
	return false;
    }
		      ...
		      unsigned int depth, struct json_sem *sem, struct json_sem_val_err **val_err)
{
    ...
    if (test == false) {
	if (val_err != NULL) {
	    *val_err = werr_sem_val(126, node, depth, sem, __func__, "invalid trigraph_warning");
	}
	return false;
    }
		      ...
		      unsigned int depth, struct json_sem *sem, struct json_sem_val_err **val_err)
{
    ...
    if (test == false) {
	if (val_err != NULL) {
	    *val_err = werr_sem_val(128, node, depth, sem, __func__, "invalid wordbuf_warning");
	}
	return false;
    }
		      ...
		      unsigned int depth, struct json_sem *sem, struct json_sem_val_err **val_err)
{
    ...
    if (test == false) {
	if (val_err != NULL) {
	    *val_err = werr_sem_val(129, node, depth, sem, __func__, "invalid ungetc_warning");
	}
	return false;
    }
		      ...
		      unsigned int depth, struct json_sem *sem, struct json_sem_val_err **val_err)
{
    ...
    if (test == false) {
	if (val_err != NULL) {
	    *val_err = werr_sem_val(130, node, depth, sem, __func__, "invalid first_rule_is_all");
	}
	return false;
    }
		      ...
		      unsigned int depth, struct json_sem *sem, struct json_sem_val_err **val_err)
{
    ...
    if (test == false) {
	if (val_err != NULL) {
	    *val_err = werr_sem_val(135, node, depth, sem, __func__, "invalid test_mode");
	}
	return false;
    }
