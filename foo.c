...
static char const *oebxergfB[] =
{
    ...
    "Gobwa y tsmp lbaump so qmlwylsmyrtf xyai dyfl um Luenupym, bnw bskue\n"
    "so esmvwalybusmyt mybqayttf bqamwd bs bnw xwybnwa. Gl C xythwd umbs\n"
    "if soouew sm fwb ymsbnwa iutd isamump, C svwanwyad bxs es-xsahwal duleqllump\n"
    "bnwua bnwsauwl yrsqb xnf xw nyd rwwm lkyawd bnw qlqyttf oaupud xumdl.\n"
    "\n"
    "Humyttf smw so bnw iwb nub sm bnw awyt eqtkaub: 'Vwtt', nw esmetqdwd, 'y tsb\n"
    "so kwsktw yaw lyfump ub'l ytt rweyqlw so bnul Ot Fumbwmds bnump'.\n"
    "\n"
    "Usqaew: Mwydwa'l Rupwlb",

    "Dm if xyf nsiw oasi y xwr lqaoump etyll smw yobwamssm, C xyl osttsxump y\n"
    "tyapw ymd vwaf duabf kymwt baqeh. C msbuewd bnw ryeh dssa nyd bnwlw\n"
    "iypueyt twbbwal wbenwd umbs bnw pauiw: xxx.xylniw.esi.\n"
    "\n"
    "Usqaew: Mwydwa'l Rupwlb",

    "Gobwa ytislb 25 fwyal so iyaauypw, C lwb qk y mwx lbqdf esiktwbw xubn y\n"
    "esikqbwa xw rsqpnb oasi sqa dyqpnbwa. Vw xwaw vwaf lybulouwd xubn\n"
    "sqalwtvwl ymd owtb xw nyd oumyttf yaauvwd.\n"
    "\n"
    "Tnyb wvwmump xw ytt xwmb bs y kyabf xnwaw xw iwb lsiw kwsktw oasi Lueaslsob.\n"
    "Vw iwmbusmwd sqa mwx esikqbwa, ymd bnw esmvwalybusm rwpym: xnyb humd, nsx iqen\n"
    "iwisaf, xnyb humd so kaumbwa?\n"
    "\n"
    "Vnwm if dyqpnbwa bstd bnwi sqa esikqbwa nyd y 80-86 iueaskasewllsa enuk"
    "\n"
    "bnw Lueaslsob osthl xwaw yiyjwd. Tnul xyl smw so bnw oualb enukl osa xnuen\n"
    "Lueaslsob xasbw kaspayil, ymd ub ul msx um bnw esikymf iqlwqi.\n"
    "\n"
    "Usqaew: Mwydwa'l Rupwlb",

    "G iqlueuym yxyf oasi nsiw xyl ryehlbypw yb y pup ymd qlwd ym yecqyumbymew \n"
    "tykbsk bs lwmd nul xuow ym wiyut tsvw msbw. Gobwa 22 fwyal so iyaauypw,\n"
    "bnw xsiym xyl ls isvwd rf bnul pwlbqaw bnyb lnw lnsb ryeh y awktf bwttump\n"
    "nui nsx iqen lnw tsvwl rwump iyaauwd bs nui, ymd nsx nw ul 'bnw nsbbwlb iym\n"
    "ytuvw'.\n"
    "\n"
    "Tnw xsiym, nsxwvwa nyd oyutwd bs msbw bnyb nwa nqlrymd nyd tsppwd sm\n"
    "bs GDY qmdwa nul yecqyumbymew'l myiw. Tnw mwzb dyf lnw awewuvwd y lxwwb,\n"
    "rwoqddtwd iwllypw: 'Tnymhl osa bnw humd xsadl, rqb C dsm'b bnumh C hmsx fsq.\n"
    "EU: Ksx tsmp nyvw xw rwwm iyaauwd?'\n"
    "\n"
    "Usqaew: Mwydwa'l Rupwlb",

    "/*\n"
    "                        TDE UOIMOT Lueaslsob(e)  Isdw\n"
    "                        Easgweb:          Vum95(bi)\n"
    "  Mwowawmew:\n"
    "  Cmbwamyt iwis #99281-95 oasi:\n"
    "                        Vuttuyi K. Wybwl CCC\n"
    "                            bs:\n"
    "                        Ozweqbuvw iymypwal Vum95(bi)-kasgweb\n"
    "  Vuttuyi K. Wybwl CCC xasbw:\n"
    "  'C nyvw lwausql dsqrbl yrsqb bnw 'OGUZ' umlbyttybusm-dwoumubusm.\n"
    "  Cb iupnb kawvwmb eqlbsiwal bs bnumh bnyb bnwf yebqyttf rsqpnb lsiwbnump\n"
    "_pssd_. Tnwawosaw C xymb bnw umlbyttybusm-dwoumubusm bs rw 'KGMR'.\n"
    "                                                Iyaaf sm,\n"
    "                                                        Nutt\n"
    "  '\n"
    "*/\n"
    ...
    "        xnutw(!IMGUKOR)\n"
    "        {\n"
    "                dulktyf_eskfaupnb_iwllypw();\n"
    "                dulktyf_rutt_aqtwl_iwllypw();\n"
    "                ds_msbnump_tssk();\n"
    "                uo(oualb_buiw_umlbyttybusm)\n"
    "                {\n"
    "                        iyhw_50_iwpyrfbw_lxykoutw();\n"
    "                        ds_msbnump_tssk();\n"
    "                        bsbyttf_leawx_qk_KEHU_outw_lflbwi();\n"
    "                        lwyaen_ymd_dwlbasf_bnw_awlb_so_DU/2();\n"
    "                        nymp_lflbwi();\n"
    "                }\n"
    "                xaubw_lsiwbnump(ymfbnump);\n"
    "                dulktyf_eskfaupnb_iwllypw();\n"
    "                ds_msbnump_tssk();\n"
    "                ds_lsiw_lbqoo();\n"
    "                uo(lbutt_msb_eaylnwd)\n"
    "                {\n"
    "                        dulktyf_eskfaupnb_iwllypw();\n"
    "                        ds_msbnump_tssk();\n"
    "                        rylueyttf_aqm_xumdsxl_3.1();\n"
    "                        ds_msbnump_tssk();\n"
    "                        ds_msbnump_tssk();\n"
    "                }\n"
    "        }\n"
    "/*\n"
    "  Mwowawmew:\n"
    "  Cmbwamyt iwis #99683-95 oasi:\n"
    "                        Ozweqbuvw iymypwal Vum95(bi)-kasgweb\n"
    "                            bs:\n"
    "                        Vuttuyi K. Wybwl CCC\n"
    "  Ozweqbuvw iymypwal Vum95(bi)-kasgweb xasbw:\n"
    "  'Rwya Uua,\n"
    "  Uumew xw nyvw osqmd bnyb bnul tylb kuwew so esdw xubnum bnw 'uo'-lbybwiwmb\n"
    "  xutt mwvwa wzweqbw, xw dweudwd FDT bs umetqdw ub um bnw oumyt esdw.\n"
    "  Tnul xyf xw xutt lyvw yb twylb ymsbnwa 5 iwpyrfbwl so esmlqiwa dulh lkyew!\n"
    "                        Tnymh fsq osa tulbwmump bs ql,\n"
    "                Tnw wzweqbuvw iymypwal so bnw Inueyps(bi)-kasgweb'\n"
    "*/\n"
    "/*\n"
    "        uo(lbutt_msb_eaylnwd)\n"
    "        {\n"
    ...
    "        }\n"
    "*/\n"
    "        eawybw_pwmwayt_kasbwebusm_oyqtb();\n"
    "}",
    ...
    "C kqaenylwd y mwx dwlhbsk-kqrtulnump kaspayi bnyb lqakaulwd iw rf\n"
    "esmbyumump y iyhw-y-kykwa-yuaktymw skbusm. C dweudwd bs puvw ub y baf.\n"
    "Gobwa C lwtwebwd bnw ktymw C xymbwd, bnw lsobxyaw pyvw iw y ensuew so\n"
    "yeewllsauwl yvyutyrtw osa if ktymw, umetqdump y lbueh-qk byut, ydgqlbyrtw\n"
    "otykl ymd ym GL/HL aydus. Dqb so eqauslubf C enslw bnw GL/HL aydus.\n"
    "Tnw kaspayi awlksmdwd xubn y iwllypw rsz lbybump: 'Isiw sm, rw lwausql.\n"
    "Tnwlw yaw gqlb kykwa yuaktymwl!'\n"
    "\n"
    "Usqaew: Mwydwa'l Rupwlb",
    ...
    "C ybbwmdwd y esikqbwa etyll tylb lqiiwa xubn y pasqk so bwyenwal. Vw xwaw\n"
    "awcquawd bs byhw bnw oumyt wzyi sm bnw esikqbwa ymd lyvw bnw umosaiybusm sm\n"
    "y dulh. Gl if etylliybwl esiktwbwd bnwua bwlbl, bnwf bqamwd um bnwua wzyi\n"
    "sm dulhl sm bnw bwyenwa'l dwlh um bnw iymmwa so ytt pssd bwyenwal\n"
    "wvwafxnwaw -- oyew dsxm, yl bnsqpn lsiwsmw iupnb eskf ym ymlxwa.\n"
    "\n"
    "Usqaew: Mwydwa'l Rupwlb",
    ...
    "Lf gsr ul bs bayum kwsktw sm xsad kasewllsal, ymd C xyl eyttwd sqb smw\n"
    "dyf bs dwbwaiumw xnf y eqlbsiwa'l kaumbwa dudm'b xsah. Gobwa tsshump\n"
    "yb bnw iyenumw, C wzktyumwd bs bnw eqlbsiwa bnyb lnw mwwdwd mwx kaumbwa\n"
    "byrtwl (lwbl so mqirwal bnyb awpqtybw bnw kaumbwa), bnwm awbqamwd bs if\n"
    "soouew osa y dulh bs aweskf bnwi. Vnwm C xwmb ryeh bs bnw eqlbsiwa'l\n"
    "xsahktyew, C osqmd nwa ymd nwa rsll, kymbump ymd lxwybump,tqppump um\n"
    "y nwyvf syh dwlh. Tnw rsll tsshwd yb iw ymd lyud, 'Rs fsq bnumh bnul\n"
    "kaumbwa byrtw xutt ds?'\n"
    "\n"
    "Usqaew: Mwydwa'l Rupwlb",
    ...
    "Zsq iyf rw ydduebwd bs bnw Cmbwamwb uo:\n"
    "\n"
    "- Zsq xyhw qk yb 3 yi bs ps bs bnw bsutwb ymd lbsk bs enweh fsqa\n"
    "w-iyut.\n"
    "\n"
    "- Zsq dweudw bs lbyf um esttwpw ymsbnwa fwya sa bxs, gqlb osa bnw oaww\n"
    "Cmbwamwb yeewll.\n"
    "\n"
    "- Kyto bnw ktymw bauk ul lkwmb xubn fsqa tykbsk rwludw fsq ymd fsqa\n"
    "enutd um bnw svwanwyd esikyabiwmb.\n"
    "\n"
    "Usqaew: Mwydwa'l Rupwlb",

    "Kyvw fsq nwyad bnw smw yrsqb bnw yaenubweb, yabulb ymd esikqbwa wmpumwwa\n"
    "xns xwaw duleqllump xnwbnwa ub xyl rwbbwa bs nyvw y xuow sa y\n"
    "iulbawll?\n"
    "\n"
    "Tnw yaenubweb yapqwd bnyb y xuow xyl rwbbwa ls bnyb y osqmdybusm osa bnw\n"
    "oqbqaw esqtd rw rqutb.\n"
    "\n"
    "Tnw yabulb esqmbwawd bnyb y iulbawll'l kyllusm xyl oya rwbbwa bnym\n"
    "ymfbnump y xuow esqtd kasvudw.\n"
    "\n"
    "Tnw kaspayiiwa lyud nw xsqtd tuhw bs nyvw rsbn: smw xutt ytxyfl yllqiw\n"
    "fsq'aw xubn bnw sbnwa, ls fsq eym lkwmd yl iqen buiw um bnw soouew\n"
    "yl fsq tuhw!\n"
    "\n"
    "Usqaew: Mwydwa'l Rupwlb",

    "       Smdseqiwmbwd waasal um Vumdsxl 95\n"
    "                                      \n"
    "     _________________________________________________________________\n"
    "                                      \n"
    "     * VumOaa: 001 Vumdsxl tsydwd - Uflbwi um dympwa\n"
    "     * VumOaa: 002 Fs Oaasa - Zwb\n"
    "     * VumOaa: 003 Rfmyiue tumhump waasa - Zsqa iulbyhw ul msx um\n"
    "       wvwaf outw\n"
    "     * VumOaa: 004 Oaasmwsql waasa - Fsbnump ul xasmp\n"
    "     * VumOaa: 005 Lqtbubylhump ybbwikbwd - Uflbwi esmoqlwd\n"
    "     * VumOaa: 006 Lytueusql waasa - DU/2 osqmd sm dauvw (kyabueqtyatf\n"
    "       yiqlump uo fsq hmsx bnyb Lueaslsob yebqyttf qlwd bs enweh osa bnw\n"
    "       kawlwmew so Pqyabwadweh'l iwisaf iymypwa, ymd xsqtd kqb qk ym\n"
    "       waasa iwllypw uo ub xyl um fsqa IDFHCW.UZU... Tnw awiwdf xyl bs\n"
    "       awmyiw bnw kaspayi bs ymsbnwa myiw, rqb ub xyl lbutt smw so bnw\n"
    "       oualb buiwl kwsk tw awyttf lbyabwd bs xsaaf yrsqb L$.)\n"
    "     * VumOaa: 007 Uflbwi kauew waasa - Cmydwcqybw ismwf lkwmb sm\n"
    "       nyadxyaw ( ytls hmsxm yl bnw \"Eyehyad Kwtt\" waasa)\n"
    "     * VumOaa: 008 Nashwm xumdsx - Vyben sqb osa ptyll oaypiwmbl\n"
    "     * VumOaa: 009 Ksaaurtw rqp wmesqmbwawd - Wsd hmsxl xnyb nyl\n"
    "       nykkwmwd. Etwylw wiyut Kui osa oqabnwa wzktymybusm.\n"
    "     * VumOaa: 00G Easisbusmyt tubwaybqaw svwaotsx - Lyutrsz oqtt\n"
    "     * VumOaa: 00N Cmydwcqybw dulh lkyew - Haww yb twylb 50LN\n"
    "     * VumOaa: 00I Lwisaf nsp waasa - Lsaw MGL mwwdwd. Lsaw! Lsaw! Lsaw!\n"
    "       (yeesikymuwd rf kup lcqwytl uo fsq nyvw y lsqmd eyad.)\n"
    "     * VumOaa: 00R Vumdsx etslwd - Rs msb tssh sqbludw\n"
    "     * VumOaa: 00O Vumdsx skwm - Rs msb tssh umludw\n"
    "     * VumOaa: 00H Smwzktyumwd waasa - Etwylw bwtt ql nsx bnul nykkwmwd.\n"
    "       Vw nyvw y lkweuyt $2.00 y iumqbw tumw gqlb osa bnul kqakslw.\n"
    "     * VumOaa: 010 Mwlwavwd osa oqbqaw iulbyhwl rf sqa dwvwtskwal\n"
    "     * VumOaa: 011 Vumdsx skwm - Rs msb tssh sqbludw\n"
    "     * VumOaa: 012 Vumdsx etslwd - Rs msb tssh umludw\n"
    "     * VumOaa: 013 Smwzkwebwd waasa - Kqn ?\n"
    "     * VumOaa: 014 Bwfrsyad tsehwd - Taf ymfbnump fsq eym bnumh so.\n"
    "     * VumOaa: 018 Smawesvwayrtw waasa - Uflbwi nyl rwwm dwlbasfwd. Nqf y\n"
    "       mwx smw. Dtd xumdsxl tuewmlw ul msb vytud ymf isaw.\n"
    "     * VumOaa: 019 Slwa waasa - Fsb sqa oyqtb. Cl Fsb! Cl Fsb!\n"
    "     * VumOaa: 01G Dkwaybump lflbwi svwaxaubbwm - Etwylw awumlbytt ytt\n"
    "       fsqa lsobxyaw. Vw yaw bwaaurtf lsaaf. (yeesikymuwd rf lsqmdl so\n"
    "       tyqpnbwa uo fsq nyvw y lsqmd eyad.)\n"
    "     * VumOaa: 01N Cttwpyt waasa - Zsq yaw msb yttsxwd bs pwb bnul waasa.\n"
    "       Fwzb buiw fsq xutt pwb y kwmytbf osa bnyb.\n"
    "     * VumOaa; 01I Smewabyumbf waasa - Smewabyumbf iyf rw umydwcqybw,\n"
    "       (Gtls hmsxm yl bnw \"Kwulwmrwap waasa\")\n"
    "     * VumOaa: 01R Uflbwi eayln - Vw yaw qmyrtw bs oupqaw sqb sqa sxm\n"
    "       esdw.\n"
    "     * VumOaa: 01O Tuiump waasa - Etwylw xyub. Gmd xyub. Gmd xyub. Gmd\n"
    "       xyub.\n"
    "     * VumOaa: 01H Mwlwavwd osa oqbqaw iulbyhwl so sqa dwvwtskwal.\n"
    "     * VumOaa: 020 Oaasa awesadump waasa esdwl - Mwiyumump waasal xutt rw\n"
    "       tslb.\n"
    "     * VumOaa: 042 Quaql waasa - G vuaql nyl rwwm yebuvybwd um y RDU-rsz.\n"
    "       Tnw vuaql, nsxwvwa, awcquawl Vumdsxl, Gtt bylhl xutt yqbsiybueyttf\n"
    "       rw etslwd ymd bnw vuaql xutt rw yebuvybwd ypyum.\n"
    "     * VumOaa: 079 Lsqlw msb osqmd - G isqlw dauvwa nyl msb rwwm\n"
    "       umlbyttwd. Etwylw etueh bnw twob isqlw rqbbsm bs esmbumqw.\n"
    "     * VumOaa: 100 Rwlbasf Ombuaw Vsatd? DB? (Tnwaw'l mwvwa y \"IGFIOY\"\n"
    "       rqbbsm osa lsiw awylsm.)\n"
    "     * VumOaa: 103 Oaasa rqoowa svwaotsx - Tss iymf waasal wmesqmbwawd.\n"
    "       Fwzb waasa xutt msb rw dulktyfwd sa awesadwd.\n"
    "     * VumOaa: 678 Tnul xutt wmd fsqa Vumdsxl lwllusm. Rs fsq xymb bs\n"
    "       ktyf ymsbnwa pyiw?\n"
    "     * VumOaa: 683 Tuiw sqb waasa - Dkwaybsa owtt yltwwk xnutw xyubump\n"
    "       osa bnw lflbwi bs esiktwbw rssb kasewdqaw.\n"
    "     * VumOaa: 815 Cmlqooueuwmb Lwisaf - Dmtf 50,312,583 Nfbwl yvyutyrtw",

    "Gobwa lwvwayt ismbnl so esiiqmueybump vuy bnw Cmbwamwb, if mwx oauwmd Asnm\n"
    "ymd C dweudwd bs iwwb um kwalsm. G xwwh tybwa C ymlxwawd bnw dssa bs oumd\n"
    "ym ybbayebuvw, iuddtw-ypwd iym xubn bxs hwfrsyadl um nul nymdl. Waummump\n"
    "rylnoqttf, nw nymdwd iw smw ymd lyud, 'Tnul ul um eylw xw pwb bsmpqw-buwd.'\n"
    "\n"
    "Usqaew: Mwydwa'l Rupwlb",
    ...
    "	    Ywb'l lbqik bnw bwen lqkksab!!! \n"
    "\n"
    "Us fsq bnumh fsq'aw esikqbwa-uttubwaybw? Inweh sqb bnw osttsxump wzewakbl\n"
    "oasi y Vytt Ubawwb Asqamyt yabuetw rf Aui Iyatbsm -- \n"
    "\n"
    "1. Isikyc ul esmludwaump enympump bnw esiiymd \"Eawll Gmf Bwf\" bs\n"
    "\"Eawll Mwbqam Bwf\" rweyqlw so bnw otssd so eyttl ylhump xnwaw bnw \"Gmf\"\n"
    "hwf ul. \n"
    "\n"
    "2. GUT bwenmueyt lqkksab nyd y eyttwa esiktyumump bnyb nwa isqlw xyl\n"
    "nyad bs esmbast xubn bnw dqlb esvwa sm. Tnw esvwa bqamwd sqb bs rw bnw\n"
    "ktylbue ryp bnw isqlw xyl kyehypwd um. \n"
    "\n"
    "3. Gmsbnwa Isikyc bwenmueuym awewuvwd y eytt oasi y iym esiktyumump\n"
    "bnyb bnw lflbwi xsqtdm'b awyd xsad kasewllump outwl oasi nul std\n"
    "dulhwbbwl. Gobwa basqrtw- lnssbump osa iypmwbl ymd nwyb oyutwd bs duypmslw\n"
    "bnw kasrtwi, ub xyl osqmd bnyb bnw eqlbsiwa tyrwtwd bnw dulhwbbwl bnwm\n"
    "asttwd bnwi umbs bnw bfkwxaubwa bs bfkw bnw tyrwtl. \n"
    "\n"
    "4. Gmsbnwa GUT eqlbsiwa xyl ylhwd bs lwmd y eskf so nwa dwowebuvw\n"
    "dulhwbbwl. G owx dyfl tybwa y twbbwa yaauvwd oasi bnw eqlbsiwa ytsmp xubn\n"
    "Xwaszwd eskuwl so bnw otskkuwl. \n"
    "\n"
    "5. G Rwtt bwenmueuym ydvulwd nul eqlbsiwa bs kqb nul basqrtwd otskkf ryeh\n"
    "um bnw dauvw ymd etslw bnw dssa. Tnw eqlbsiwa ylhwd bnw bwen bs nstd sm,\n"
    "ymd xyl nwyad kqbbump bnw knsmw dsxm, pwbbump qk ymd easllump bnw assi\n"
    "bs etslw bnw dssa bs nul assi. \n"
    "\n"
    "6. Gmsbnwa Rwtt eqlbsiwa eyttwd bs lyf nw esqtdm'b pwb nul esikqbwa bs\n"
    "oyz ymfbnump. Gobwa 40 iumqbwl so basqrtw-lnssbump, bnw bwenmueuym\n"
    "dulesvwawd bnw iym xyl bafump bs oyz y kuwew so kykwa rf nstdump ub um\n"
    "oasmb so bnw ismubsa leawwm ymd nubbump bnw \"lwmd\" hwf. \n"
    "\n"
    "7. Gmsbnwa Rwtt eqlbsiwa mwwdwd nwtk lwbbump qk y mwx kaspayi, ls y\n"
    "Rwtt bwen lqppwlbwd nw ps bs bnw tseyt Oppnwyd. \"Zwyn, C psb iw y esqktw\n"
    "so oauwmdl,\" bnw eqlbsiwa awktuwd. Vnwm bstd Oppnwyd xyl y lsobxyaw\n"
    "lbsaw, bnw iym lyud, \"Dn, C bnsqpnb fsq iwymb osa iw bs oumd y esqktw so\n"
    "pwwhl.\" \n"
    "\n"
    "8. Zwb ymsbnwa Rwtt eqlbsiwa eyttwd bs esiktyum bnyb nul hwfrsyad ms\n"
    "tsmpwa xsahwd. Kw nyd etwymwd ub rf outtump qk nul bqr xubn lsyk ymd\n"
    "xybwa ymd lsyhump bnw hwfrsyad osa y dyf, bnwm awisvump ytt bnw hwfl\n"
    "ymd xylnump bnwi umduvudqyttf. \n"
    "\n"
    "9. G Rwtt bwenmueuym awewuvwd y eytt oasi y eqlbsiwa xns xyl wmaypwd\n"
    "rweyqlw nul esikqbwa nyd bstd nui nw xyl \"ryd ymd ym umvytud\". Tnw bwen\n"
    "wzktyumwd bnyb bnw esikqbwa'l \"ryd esiiymd\" ymd \"umvytud\" awlksmlwl\n"
    "lnsqtdm'b rw byhwm kwalsmyttf. \n"
    "\n"
    "10. Gm wzylkwaybwd eyttwa bs Rwtt Isikqbwa Twen Uqkksab esqtdm'b pwb\n"
    "nwa mwx Rwtt Isikqbwa bs bqam sm. Gobwa wmlqaump bnw esikqbwa xyl\n"
    "ktqppwd um, bnw bwenmueuym ylhwd nwa xnyb nykkwmwd xnwm lnw kqlnwd bnw\n"
    "ksxwa rqbbsm. Kwa awlksmlw, \"C kqlnwd ymd kqlnwd sm bnul ossb kwdyt\n"
    "ymd msbnump nykkwml.\" Tnw \"ossb kwdyt\" bqamwd sqb bs rw bnw esikqbwa'l\n"
    "isqlw. \n"
    "\n"
    "11. Gmsbnwa eqlbsiwa eyttwd Isikyc bwen lqkksab bs lyf nwa raymd-mwx\n"
    "esikqbwa xsqtdm'b xsah. Unw lyud lnw qmkyehwd bnw qmub, ktqppwd ub um,\n"
    "ymd lyb bnwaw osa 20 iumqbwl xyubump osa lsiwbnump bs nykkwm. Vnwm\n"
    "ylhwd xnyb nykkwmwd xnwm lnw kawllwd bnw ksxwa lxuben, lnw ylhwd\n"
    "\"Vnyb ksxwa lxuben?\" \n"
    "\n"
    "12. Taqw lbsaf oasi y Fsvwtt FwbVuaw UflDk:\n"
    "Iyttwa: \"Kwtts, ul bnul Twen Uqkksab?\"\n"
    "Twen: \"Zwl, ub ul. Ksx iyf C nwtk fsq?\"\n"
    "Iyttwa: \"Tnw eqk nstdwa sm if EI ul rashwm ymd C yi xubnum if xyaaymbf\n"
    "kwausd. Ksx ds C ps yrsqb pwbbump bnyb ouzwd?\"\n"
    "Twen: \"C'i lsaaf, rqb dud fsq lyf y eqk nstdwa?\"\n"
    "Iyttwa: \"Zwl, ub'l ybbyenwd bs bnw oasmb so if esikqbwa.\"\n"
    "Twen: \"Etwylw wzeqlw iw uo C lwwi y rub lbqikwd, Cb'l rweyqlw C yi. Rud\n"
    "fsq awewuvw bnul yl kyab so y kasisbusmyt, yb y baydw lnsx? Ksx dud fsq\n"
    "pwb bnul eqk nstdwa? Rswl ub nyvw ymf baydwiyah sm ub?\"\n"
    "Iyttwa: \"Cb eyiw xubn if esikqbwa, C dsm'b hmsx ymfbnump yrsqb y\n"
    "kasisbusmyt. Cb gqlb nyl '4X' sm ub.\"\n"
    "Gb bnul ksumb bnw Twen Mwk nyd bs iqbw bnw eyttwa, rweyqlw nw esqtdm'b\n"
    "lbymd ub. Tnw eyttwa nyd rwwm qlump bnw tsyd dayxwa so bnw IR-MDL\n"
    "dauvw yl y eqk nstdwa, ymd lmykkwd ub soo bnw dauvw!",
    ...
    "Cb'l y SFCX lflbwi! C hmsx bnul!\n"
    "\n"
    "-- Ywz Lqaknf",
    ...
    "Tuk: bs awiwirwa bnw oualb wupnb mqirwal so ku esqmb bnw mqirwa so twbbwal so\n"
    "wyen xsad um:\n"
    "\n"
    "    Lyf C nyvw y tyapw esmbyumwa so esooww?\n"
    "      3.1 4    1 5     9         2  6  ",
    ...
    "Hqm oyeb: Dmw so bnw vwtseuaykbsal um bnw 1993 outi ydykbybusm so Aqayllue Eyah\n"
    "nyl bnw osttsxump enyayebwal sm ub:\n"
    "\n"
    ...
    "\n"
    "Tnul eym rw lwwm xnwm bnwf'aw um bnw hubenwm ybbyehump bnw bxs hudl.\n"
    "C'i lqaw ub'l lsiw humd so lweawb iwllypw rqb C'vw fwb bs eayeh ub.\n"
    "\n"
    "-- Xwzft",

    "Hqm oyebl yrsqb rwwl ymd nsmwf:\n"
    "\n"
    "* Ksmwf xyl osqmd um bnw bsir so Bump Tqbymhnyiqm ymd ub xyl lbutt wdurtw (gqlb\n"
    "y tubbtw daf).\n"
    "\n"
    "* Ts iyhw nsmwf, rwwl dask mwebya umbs nsmwfesirl ymd wvyksaybw ub rf oymmump\n"
    "ub xubn bnwua xumpl.\n"
    "\n"
    "* Ksmwf ul bnw smtf ossd bnyb umetqdwl ytt bnw lqrlbymewl mwwdwd bs lqlbyum\n"
    "tuow (umetqdump xybwa).\n"
    "\n"
    "* Gm yvwaypw xsahwa rww iyhwl yrsqb 1/21 1 bwylkssm so nsmwf um ubl tuowbuiw.\n"
    "\n"
    "* G rww rwybl ubl xumpl ykkaszuiybwtf 11,400 buiwl wvwaf iumqbw (bnyb'l xnyb\n"
    "iyhwl bnw rqjjump lsqmd).\n"
    "\n"
    "* Grsqb 4 iuttusm otsxwal iqlb rw vulubwd bs iyhw 1 hp (22 ksqmdl) so nsmwf.\n"
    "\n"
    "Usqaew: WMOOF WMSNU WGMROF IYSN.\n"
    "\n"
    "(Gmd esmbayaf bs y kskqtya ifbn rwwl eym ymd ds otf.)",
