 ...
 *
 * Sorry (tm Canada :-)) for the condition of the code below.
 *
 ...
 *
 * We do NOT recommend that you modify this code, however
 * offensive or ugly it might seem, but instead work on
 * the bison *.y and flex *.l source files.  See the Makefile
 * for more information on how this file was generated.
 *
