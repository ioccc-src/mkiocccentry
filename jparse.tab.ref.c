 ...
 * to the output of Bison and Flex borders on programming sanctimoniousness.  At
 * first glance, this incongruence is unsustainable.  In response we opine that
 * one of the fundamental undertones of the IOCCC are the promotion of good
 * programming through the irony awarding highly obfuscated C code.  So, if it
 * helps, we suggest you view this apology in a satirical light, even if you are
 * humour impaired.  Nevertheless, we still recommend you to eschew modifying
 * the code below.
 *
...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_JSON_UINTMAX = 13,              /* JSON_UINTMAX  */
  YYSYMBOL_JSON_INTMAX = 14,               /* JSON_INTMAX  */
  YYSYMBOL_JSON_LONG_DOUBLE = 15,          /* JSON_LONG_DOUBLE  */
...
{
       0,   139,   139,   140,   141,   142,   145,   146,   147,   148,
     149,   150,   151,   154,   155,   156,   158,   161,   162,   165,
     168,   171,   172,   175
};
#endif
...
static const char *const yytname[] =
{
  ...
  "\"[\"", "\"]\"", "\",\"", "\":\"", "\"null\"", "\"true\"", "\"false\"",
  "JSON_STRING", "JSON_UINTMAX", "JSON_INTMAX", "JSON_LONG_DOUBLE",
  "$accept", "json", "json_value", "json_number", "json_object",
...
{
      18,     2,    -2,    -9,    -9,    -9,    -9,    -9,    -9,    -9,
       5,    -9,    -9,    -9,    -9,    -9,    -9,    -6,    11,     9,
       6,    31,    -9,    13,    10,    -9,    31,    -9,     6,    -9,
      31,    -9,    -9,    -9
};
...
{
      15,    20,    26,    21,    22,    25,    16,     3,     4,     5,
       6,     7,     8,     9,    17,    27,    28,    30,    17,    29,
      32,     1,     0,     2,     0,    33,    31,     3,     4,     5,
...
{
       0,     3,     8,     5,     6,     0,     4,     9,    10,    11,
      12,    13,    14,    15,    12,     4,     7,     7,    12,     6,
      28,     3,    -1,     5,    -1,    30,    26,     9,    10,    11,
