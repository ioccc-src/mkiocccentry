...
Updated `jparse_bug_report.sh` to not rely on `cpp` for getting predefined
macros.

Updated `JPARSE_LIBRARY_VERSION` to `"2.4.3 2025-11-10"`.
Updated `JPARSE_BUG_REPORT_VERSION` to `"2.1.3 2025-11-10"` (previously was
`BUG_REPORT_VERSION`).
