...
#define JNAMVAL_RESTRICT_TYPE_SIMPLE  (JNAMVAL_RESTRICT_TYPE_NUM|JNAMVAL_RESTRICT_TYPE_BOOL| \
	JNAMVAL_RESTRICT_TYPE_STR|JNAMVAL_RESTRICT_TYPE_NULL)
/* JNAMVAL_RESTRICT_TYPE_COMPOUND is bitwise OR of member, object and array */
#define JNAMVAL_RESTRICT_TYPE_COMPOUND (JNAMVAL_RESTRICT_TYPE_MEMBER|JNAMVAL_RESTRICT_TYPE_OBJECT| \
	JNAMVAL_RESTRICT_TYPE_ARRAY)
