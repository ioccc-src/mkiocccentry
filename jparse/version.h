 ...
 */
#define JPARSE_REPO_VERSION "2.4.3 2025-09-29"		/* format: major.minor YYYY-MM-DD */

/*
 * official jparse version
 */
#define JPARSE_TOOL_VERSION "2.0.3 2025-09-29"		/* format: major.minor YYYY-MM-DD */

/*
 * official JSON parser version
 */
#define JPARSE_LIBRARY_VERSION "2.4.2 2025-09-29"	/* library version format: major.minor YYYY-MM-DD */

/*
 * official utility functions (util.c) version
 */
#define JPARSE_UTILS_VERSION "2.1.5 2025-09-29"         /* format: major.minor YYYY-MM-DD */
