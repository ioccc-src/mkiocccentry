 ...
 */
#define JPARSE_REPO_VERSION "2.5.3 2025-11-11"		/* format: major.minor YYYY-MM-DD */

/*
 * official jparse version
 */
#define JPARSE_TOOL_VERSION "2.0.3 2025-10-02"		/* format: major.minor YYYY-MM-DD */

/*
 * official JSON parser version
 */
#define JPARSE_LIBRARY_VERSION "2.4.3 2025-11-11"	/* library version format: major.minor YYYY-MM-DD */
