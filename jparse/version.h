 ...
 */
#define JPARSE_REPO_VERSION "2.1.9 2024-12-26"		/* format: major.minor YYYY-MM-DD */

/*
 * official jparse version
 */
#define JPARSE_VERSION "1.2.7 2024-12-22"		/* format: major.minor YYYY-MM-DD */

/*
 * official JSON parser version
 */
#define JPARSE_LIBRARY_VERSION "2.2.2 2024-12-01"	/* library version format: major.minor YYYY-MM-DD */
