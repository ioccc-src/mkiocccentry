...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_JSON_TRUE = 9,                  /* JSON_TRUE  */
  YYSYMBOL_JSON_FALSE = 10,                /* JSON_FALSE  */
  YYSYMBOL_JSON_NULL = 11,                 /* JSON_NULL  */
  ...
  YYSYMBOL_JSON_ARRAY = 20,                /* JSON_ARRAY  */
...
static const char *const yytname[] =
{
  ...
  "JSON_CLOSE_BRACE", "JSON_OPEN_BRACKET", "JSON_CLOSE_BRACKET", "COMMA",
  "COLON", "JSON_TRUE", "JSON_FALSE", "JSON_NULL", "JSON_STRING",
  "JSON_NUMBER", "$accept", "json", "value", "object", "members", "member",
  "JSON_ARRAY", "values", YY_NULLPTR
};
