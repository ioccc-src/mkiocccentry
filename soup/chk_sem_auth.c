...
/* depth    type        min     max   count   index  name_len validate  name */
  ...
  { 1,	JTYPE_MEMBER,	1,	1,	1,	28,	15,	chk_fnamchk_version,	"fnamchk_version" },
  { 1,	JTYPE_MEMBER,	1,	1,	1,	29,	10,	chk_formed_UTC,	"formed_UTC" },
  { 1,	JTYPE_MEMBER,	1,	1,	1,	30,	16,	chk_formed_timestamp,	"formed_timestamp" },
  { 1,	JTYPE_MEMBER,	1,	1,	1,	31,	21,	chk_formed_timestamp_usec,	"formed_timestamp_usec" },
  ...
  { 1,	JTYPE_MEMBER,	1,	1,	1,	35,	14,	chk_submission_num,	"submission_num" },
