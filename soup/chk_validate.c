	      ...
	      unsigned int depth, struct json_sem *sem, struct json_sem_val_err **val_err)
{
    ...
    if (test == false) {
	if (val_err != NULL) {
	    *val_err = werr_sem_val(137, node, depth, sem, __func__, "invalid info_JSON filename");
	}
	return false;
    }
		  ...
		  unsigned int depth, struct json_sem *sem, struct json_sem_val_err **val_err)
{
    ...
    if (test == false) {
	if (val_err != NULL) {
	    *val_err = werr_sem_val(138, node, depth, sem, __func__, "invalid IOCCC_contest");
	}
	return false;
    }
	       ...
	       unsigned int depth, struct json_sem *sem, struct json_sem_val_err **val_err)
{
    ...
    if (test == false) {
	if (val_err != NULL) {
	    *val_err = werr_sem_val(139, node, depth, sem, __func__, "invalid IOCCC_year");
	}
	return false;
    }
		      ...
		      unsigned int depth, struct json_sem *sem, struct json_sem_val_err **val_err)
{
    ...
    if (test == false) {
	if (val_err != NULL) {
	    *val_err = werr_sem_val(140, node, depth, sem, __func__, "invalid iocccsize_version");
	}
	return false;
    }
		  ...
		  unsigned int depth, struct json_sem *sem, struct json_sem_val_err **val_err)
{
    ...
    if (test == false) {
	if (val_err != NULL) {
	    *val_err = werr_sem_val(141, node, depth, sem, __func__, "invalid location_code");
	}
	return false;
    }
	     ...
	     unsigned int depth, struct json_sem *sem, struct json_sem_val_err **val_err)
{
    ...
    if (node->type != JTYPE_MEMBER) {
	if (val_err != NULL) {
	    *val_err = werr_sem_val(142, node, depth, sem, __func__, "node type %s != JTYPE_MEMBER",
				    json_type_name(node->type));
	}
	return false;
    }
    ...
    if (value->type != JTYPE_ARRAY) {
	if (val_err != NULL) {
	    *val_err = werr_sem_val(143, node, depth, sem, __func__, "node type %s != JTYPE_ARRAY",
				    json_type_name(value->type));
	}
	return false;
    }
    ...
    if (array->set == NULL) {
	if (val_err != NULL) {
	    *val_err = werr_sem_val(144, node, depth+1, sem, __func__,
				    "node value JTYPE_ARRAY set is NULL");
	}
	return false;
    }
		  ...
		  unsigned int depth, struct json_sem *sem, struct json_sem_val_err **val_err)
{
    ...
    if (test == false) {
	if (val_err != NULL) {
	    *val_err = werr_sem_val(146, node, depth, sem, __func__, "invalid min_timestamp");
	}
	return false;
    }
			 ...
			 unsigned int depth, struct json_sem *sem, struct json_sem_val_err **val_err)
{
    ...
    if (test == false) {
	if (val_err != NULL) {
	    *val_err = werr_sem_val(147, node, depth, sem, __func__, "invalid mkiocccentry_version");
	}
	return false;
    }
	 ...
	 unsigned int depth, struct json_sem *sem, struct json_sem_val_err **val_err)
{
    ...
    if (test == false) {
	if (val_err != NULL) {
	    *val_err = werr_sem_val(148, node, depth, sem, __func__, "invalid name");
	}
	return false;
    }
	       ...
	       unsigned int depth, struct json_sem *sem, struct json_sem_val_err **val_err)
{
    ...
    if (test == false) {
	if (val_err != NULL) {
	    *val_err = werr_sem_val(149, node, depth, sem, __func__, "invalid no_comment");
	}
	return false;
    }
		...
		unsigned int depth, struct json_sem *sem, struct json_sem_val_err **val_err)
{
    ...
    if (test == false) {
	if (val_err != NULL) {
	    *val_err = werr_sem_val(150, node, depth, sem, __func__, "invalid past_winning_author");
	}
	return false;
    }
			 ...
			 unsigned int depth, struct json_sem *sem, struct json_sem_val_err **val_err)
{
    ...
    if (test == false) {
	if (val_err != NULL) {
	    *val_err = werr_sem_val(151, node, depth, sem, __func__, "invalid remarks filename");
	}
	return false;
    }
		     ...
		     unsigned int depth, struct json_sem *sem, struct json_sem_val_err **val_err)
{
    ...
    if (test == false) {
	if (val_err != NULL) {
	    *val_err = werr_sem_val(153, node, depth, sem, __func__, "invalid rule_2a_override");
	}
	return false;
    }
	     ...
	     unsigned int depth, struct json_sem *sem, struct json_sem_val_err **val_err)
{
    ...
    if (test == false) {
	if (val_err != NULL) {
	    *val_err = werr_sem_val(154, node, depth, sem, __func__, "invalid rule_2a_size");
	}
	return false;
    }
		      ...
		      unsigned int depth, struct json_sem *sem, struct json_sem_val_err **val_err)
{
    ...
    if (test == false) {
	if (val_err != NULL) {
	    *val_err = werr_sem_val(155, node, depth, sem, __func__, "invalid rule_2b_override");
	}
	return false;
    }
	     ...
	     unsigned int depth, struct json_sem *sem, struct json_sem_val_err **val_err)
{
    ...
    if (test == false) {
	if (val_err != NULL) {
	    *val_err = werr_sem_val(156, node, depth, sem, __func__, "invalid rule_2b_size");
	}
	return false;
    }
	   ...
	   unsigned int depth, struct json_sem *sem, struct json_sem_val_err **val_err)
{
    ...
    if (node->type != JTYPE_MEMBER) {
	if (val_err != NULL) {
	    *val_err = werr_sem_val(157, node, depth, sem, __func__, "node type %s != JTYPE_MEMBER",
				    json_type_name(node->type));
	}
	return false;
    }
    ...
    if (test == false) {
	if (val_err != NULL) {
	    *val_err = werr_sem_val(158, node, depth, sem, __func__, "invalid IOCCC_contest_id");
	}
	return false;
    }
    ...
    if (test == false) {
	if (val_err != NULL) {
	    *val_err = werr_sem_val(159, node, depth, sem, __func__, "invalid submit_slot");
	}
	return false;
    }
    ...
    if (test == false) {
	if (val_err != NULL) {
	    *val_err = werr_sem_val(161, node, depth, sem, __func__, "invalid formed_timestamp");
	}
	return false;
    }
    ...
    if (test == false) {
	if (val_err != NULL) {
	    *val_err = werr_sem_val(162, node, depth, sem, __func__, "invalid tarball");
	}
	return false;
    }
			 ...
			 unsigned int depth, struct json_sem *sem, struct json_sem_val_err **val_err)
{
    ...
    if (test == false) {
	if (val_err != NULL) {
	    *val_err = werr_sem_val(164, node, depth, sem, __func__, "invalid timestamp_epoch");
	}
	return false;
    }
			 ...
			 unsigned int depth, struct json_sem *sem, struct json_sem_val_err **val_err)
{
    ...
    if (test == false) {
	if (val_err != NULL) {
	    *val_err = werr_sem_val(165, node, depth, sem, __func__, "invalid title");
	}
	return false;
    }
		     ...
		     unsigned int depth, struct json_sem *sem, struct json_sem_val_err **val_err)
{
    ...
    if (test == false) {
	if (val_err != NULL) {
	    *val_err = werr_sem_val(166, node, depth, sem, __func__, "invalid trigraph_warning");
	}
	return false;
    }
			 ...
			 unsigned int depth, struct json_sem *sem, struct json_sem_val_err **val_err)
{
    ...
    if (val.str == NULL) {
	if (val_err != NULL) {
	    *val_err = werr_sem_val(167, node, depth, sem, __func__,
				    "val.valid true, val.is_null false, but val.str is NULL");
	}
	return false;
    }
    ...
    if (test == false) {
	if (val_err != NULL) {
	    *val_err = werr_sem_val(168, node, depth, sem, __func__, "invalid mastodon");
	}
	return false;
    }
			 ...
			 unsigned int depth, struct json_sem *sem, struct json_sem_val_err **val_err)
{
    ...
    if (test == false) {
	if (val_err != NULL) {
	    *val_err = werr_sem_val(169, node, depth, sem, __func__, "invalid txzchk_version");
	}
	return false;
    }
		   ...
		   unsigned int depth, struct json_sem *sem, struct json_sem_val_err **val_err)
{
    ...
    if (test == false) {
	if (val_err != NULL) {
	    *val_err = werr_sem_val(170, node, depth, sem, __func__, "invalid ungetc_warning");
	}
	return false;
    }
			 ...
			 unsigned int depth, struct json_sem *sem, struct json_sem_val_err **val_err)
{
    ...
    if (val.str == NULL) {
	if (val_err != NULL) {
	    *val_err = werr_sem_val(171, node, depth, sem, __func__,
				    "val.valid true, val.is_null false, but val.str is NULL");
	}
	return false;
    }
    ...
    if (test == false) {
	if (val_err != NULL) {
	    *val_err = werr_sem_val(172, node, depth, sem, __func__, "invalid url");
	}
	return false;
    }
