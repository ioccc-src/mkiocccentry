...
/*  {"OA", "African Intellectual Property Organization"}, */ /* WIPO Indeterminately reserved code */
    ...
    {"TN", "Tunisia"},
    {"TO", "Tonga"},
    {"TP", "T\xc3\x9crkiye"},		/* Transitionally reserved code */
    {"TR", "T\xc3\x9crkiye"},
    {"TT", "Trinidad and Tobago"},
    {"TV", "Tuvalu"},
    {"TW", "Taiwan"},		/* common name for location known to some as Taiwan, Province of China */
...
/*  {"WO", "World Intellectual Property Organization"}, */ /* WIPO Indeterminately reserved code */
    ...
    {"XA", "Canary Islands"},		/* User-assigned code - XA is being used by Switzerland */
    ...
    {"XI", "Northern Ireland"},		/* User-assigned code - used by the UK Government as an EORI code prefix */
    {"XJ", "User-assigned code XJ"},	/* User-assigned code */
    {"XK", "Kosovo"},			/* User-assigned code - used by the European Commission for Kosovo */
