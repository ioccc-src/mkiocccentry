 ...
 */
#define MKIOCCCENTRY_REPO_VERSION "2.3.25 2025-02-05"	/* special release format: major.minor[.patch] YYYY-MM-DD */
 ...
 */
#define MKIOCCCENTRY_VERSION "1.2.15 2025-02-05"	/* format: major.minor YYYY-MM-DD */
