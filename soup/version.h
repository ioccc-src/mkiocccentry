 ...
 */
#define MKIOCCCENTRY_REPO_VERSION "2.3.30 2025-02-10"	/* special release format: major.minor[.patch] YYYY-MM-DD */
 ...
 */
#define MKIOCCCENTRY_VERSION "1.2.20 2025-02-10"	/* format: major.minor YYYY-MM-DD */
