 ...
 */
#define MKIOCCCENTRY_REPO_VERSION "2.3.24 2025-02-03"	/* special release format: major.minor[.patch] YYYY-MM-DD */
 ...
 */
#define MKIOCCCENTRY_VERSION "1.2.14 2025-02-04"	/* format: major.minor YYYY-MM-DD */
