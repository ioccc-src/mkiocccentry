 ...
 */
#define MKIOCCCENTRY_REPO_VERSION "2.3.23 2025-02-03"	/* special release format: major.minor[.patch] YYYY-MM-DD */
 ...
 */
#define MKIOCCCENTRY_VERSION "1.2.13 2025-02-03"	/* format: major.minor YYYY-MM-DD */
