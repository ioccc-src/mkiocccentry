...
main(int argc, char **argv)
{
    ...
    if (name == NULL) {
        err(32, __func__, "dir_name(\"%s\", -1): returned NULL", relpath);
        not_reached();
    } else if (strcmp(name, ".") != 0) {
        err(33, __func__, "dir_name(\"%s\", -1): returned \"%s\", expected \".\"", relpath, name);
        not_reached();
    } else {
    ...
    if (name == NULL) {
        ...
        err(35, __func__, "dir_name(\"%s\", -1): returned \"%s\", expected \"%s\"", relpath, name, relpath+2);
        not_reached();
    } else {
    ...
    if (name == NULL) {
        ...
        err(37, __func__, "dir_name(\"%s\", -1): returned \"%s\", expected \"foo\"", relpath, name);
        not_reached();
    } else {
    ...
    if (name == NULL) {
        ...
        err(39, __func__, "dir_name(\"%s\", -1): returned \"%s\", expected \"foo\"", relpath, name);
        not_reached();
    } else {
        fdbg(stderr, DBG_MED, "dir_name(\"%s\", -1): got expected \"foo\"", relpath);
    }
    ...
    if (name == NULL) {
        ...
        err(43, __func__, "dir_name(\"%s\", -1): returned \"%s\", expected \"/\"", relpath, name);
        not_reached();
    } else {
    ...
    if (name == NULL) {
        ...
        err(45, __func__, "dir_name(\"%s\", -1): returned \"%s\", expected \".\"", relpath, name);
        not_reached();
    } else {
        fdbg(stderr, DBG_MED, "dir_name(\"%s\", -1): got expected \".\"", relpath);
    }
    ...
    if (name == NULL) {
        ...
        err(49, __func__, "dir_name(\"%s\", -1): returned \"%s\", expected \"%s\"", relpath, name, relpath);
        not_reached();
    } else {
    ...
    if (name == NULL) {
        ...
        err(53, __func__, "dir_name(\"%s\", -1): returned \"%s\", expected \".\"", relpath, name);
        not_reached();
    } else {
        fdbg(stderr, DBG_MED, "dir_name(\"%s\", -1): got expected \".\"", relpath);
    }
    ...
    if (name == NULL) {
        ...
        err(57, __func__, "dir_name(\"%s\", -1): returned \"%s\", expected \"%s\"", relpath, name, relpath);
        not_reached();
    } else {
        fdbg(stderr, DBG_MED, "dir_name(\"%s\", -1): got expected \"%s\"", relpath, relpath);
    }
    ...
    if (name == NULL) {
        ...
        err(61, __func__, "dir_name(\"%s\", -1): returned %s, expected: foo", relpath, name);
        not_reached();
    } else {
        fdbg(stderr, DBG_MED, "dir_name(\"%s\", -1): %s", relpath, name);
    }
    ...
    if (name == NULL) {
        err(62, __func__, "dir_name(\"%s\", 0): returned NULL", relpath);
        not_reached();
    } else if (strcmp(name, relpath) != 0) {
        err(63, __func__, "dir_name(\"%s\", 0): returned %s, expected: %s", relpath, name, relpath);
        not_reached();
    } else {
    ...
    if (name == NULL) {
        ...
        err(65, __func__, "dir_name(\"%s\", 1): returned %s, expected: foo/bar/baz/zab/rab", relpath, name);
        not_reached();
    } else {
    ...
    if (name == NULL) {
        err(66, __func__, "dir_name(\"%s\", 2): returned NULL", relpath);
        not_reached();
    } else if (strcmp(name, "foo/bar/baz/zab") != 0) {
        err(67, __func__, "dir_name(\"%s\", 2): returned %s, expected: foo/bar/baz/zab", relpath, name);
        not_reached();
    } else {
    ...
    if (name == NULL) {
        err(68, __func__, "dir_name(\"%s\", 3): returned NULL", relpath);
        not_reached();
    } else if (strcmp(name, "foo/bar/baz") != 0) {
        err(69, __func__, "dir_name(\"%s\", 3): returned %s, expected: foo/bar/baz", relpath, name);
        not_reached();
    } else {
    ...
    if (name == NULL) {
        err(70, __func__, "dir_name(\"%s\", 4): returned NULL", relpath);
        not_reached();
    } else if (strcmp(name, "foo/bar") != 0) {
        err(71, __func__, "dir_name(\"%s\", 4): returned %s, expected: foo/bar", relpath, name);
        not_reached();
    } else {
    ...
    if (name == NULL) {
        err(72, __func__, "dir_name(\"%s\", 5): returned NULL", relpath);
        not_reached();
    } else if (strcmp(name, "foo") != 0) {
        err(73, __func__, "dir_name(\"%s\", 5): returned %s, expected: foo", relpath, name);
        not_reached();
    } else {
    ...
    if (name == NULL) {
        err(74, __func__, "dir_name(\"%s\", 6): returned NULL", relpath);
        not_reached();
    } else if (strcmp(name, "foo") != 0) {
        err(75, __func__, "dir_name(\"%s\", 6): returned %s, expected: foo", relpath, name);
        not_reached();
    } else {
    ...
    if (name == NULL) {
        err(78, __func__, "dir_name(NULL, -1): returned NULL");
        not_reached();
    } else if (strcmp(name, ".") != 0) {
        err(79, __func__, "dir_name(NULL, -1): returned %s, expected: \".\"", name);
        not_reached();
    } else {
    ...
    name = dir_name("", -1);
    if (name == NULL) {
        err(80, __func__, "dir_name(\"\", -1): returned NULL");
        not_reached();
    } else if (strcmp(name, ".") != 0) {
        err(81, __func__, "dir_name(\"\", -1): returned %s, expected: \".\"", name);
        not_reached();
    } else {
    ...
    if (name == NULL) {
        err(82, __func__, "base_name(\"%s\"): returned NULL", relpath);
        not_reached();
    } else if (strcmp(name, "oof") != 0) {
        err(83, __func__, "base_name(\"%s\"): returned %s, expected: oof", relpath, name);
        not_reached();
    } else {
    ...
    name = base_name(NULL);
    if (name == NULL) {
        err(84, __func__, "base_name(NULL): returned NULL");
        not_reached();
    } else if (strcmp(name, ".") != 0) {
        err(85, __func__, "base_name(NULL): returned %s, expected: \".\"", name);
        not_reached();
    } else {
    ...
    if (name == NULL) {
        ...
        err(87, __func__, "base_name(\"%s\"): returned %s, expected: \".\"", relpath, name);
        not_reached();
    } else {
    ...
    if (comps != 2) {
        err(88, __func__, "count_dirs(\"%s\"): %ju != 2", relpath, comps);
        not_reached();
    } else {
    ...
    comps = count_dirs(relpath);
    if (comps != 1) {
        err(90, __func__, "count_dirs(\"%s\"): %ju != 1", relpath, comps);
        not_reached();
    } else {
        fdbg(stderr, DBG_MED, "count_dirs(\"%s\") == 1", relpath);
    }
    ...
    comps = count_dirs(relpath);
    if (comps != 1) {
        err(91, __func__, "count_dirs(\"%s\"): %ju != 1", relpath, comps);
        not_reached();
    } else {
        fdbg(stderr, DBG_MED, "count_dirs(\"%s\") == 1", relpath);
    }
    ...
    comps = count_dirs(relpath);
    if (comps != 0) {
        err(93, __func__, "count_dirs(\"%s\"): %ju != 0", relpath, comps);
        not_reached();
    } else {
    ...
    comps = count_dirs(relpath);
    if (comps != 2) {
        err(94, __func__, "count_dirs(\"%s\"): %ju != 2", relpath, comps);
        not_reached();
    } else {
        fdbg(stderr, DBG_MED, "count_dirs(\"%s\") == 2", relpath);
    }
    ...
    comps = count_dirs(relpath);
    if (comps != 4) {
        err(95, __func__, "count_dirs(\"%s\"): %ju != 4", relpath, comps);
        not_reached();
    } else {
    ...
    comps = count_dirs(relpath);
    if (comps != 2) {
        err(96, __func__, "count_dirs(\"%s\"): %ju != 2", relpath, comps);
        not_reached();
    } else {
        fdbg(stderr, DBG_MED, "count_dirs(\"%s\") == 2", relpath);
    }
    ...
    comps = count_dirs(relpath);
    if (comps != 4) {
        err(97, __func__, "count_dirs(\"%s\"): %ju != 4", relpath, comps);
        not_reached();
    } else {
        fdbg(stderr, DBG_MED, "count_dirs(\"%s\") == 4", relpath);
    }
    ...
    comps = count_dirs(relpath);
    if (comps != 1) {
        err(98, __func__, "count_dirs(\"%s\"): %ju != 1", relpath, comps);
        not_reached();
    } else {
        fdbg(stderr, DBG_MED, "count_dirs(\"%s\") == 1", relpath);
    }
    ...
    comps = count_dirs(relpath);
    if (comps != 3) {
        err(99, __func__, "count_dirs(\"%s\"): %ju != 3", relpath, comps);
        not_reached();
    } else {
    ...
    comps = count_dirs(relpath);
    if (comps != 1) {
        err(100, __func__, "count_dirs(\"%s\"): %ju != 1", relpath, comps);
        not_reached();
    } else {
        fdbg(stderr, DBG_MED, "count_dirs(\"%s\") == 1", relpath);
    }
    ...
    comps = count_dirs(relpath);
    if (comps != 3) {
        err(101, __func__, "count_dirs(\"%s\"): %ju != 3", relpath, comps);
        not_reached();
    } else {
        fdbg(stderr, DBG_MED, "count_dirs(\"%s\") == 3", relpath);
    }
    ...
    if (comps != 2) {
        err(102, __func__, "count_comps(\"%s\", ',', true): %ju != 2", relpath, comps);
        not_reached();
    } else {
    ...
    if (!path_has_component(relpath, "baz")) {
        err(103, __func__, "path_has_component(\"%s\", \"baz\") returned false: expected true", relpath);
        not_reached();
    } else {
    ...
    if (!path_has_component(relpath, "bar")) {
        err(104, __func__, "path_has_component(\"%s\", \"bar\") returned false: expected true", relpath);
        not_reached();
    } else {
    ...
    relpath = "foo//bar/baz";
    if (!path_has_component(relpath, "bar")) {
        err(105, __func__, "path_has_component(\"%s\", \"bar\") returned false: expected true", relpath);
        not_reached();
    } else {
        fdbg(stderr, DBG_MED, "path_has_component(\"%s\", \"bar\") == true", relpath);
    }
    ...
    if (!path_has_component(relpath, ".git")) {
        err(107, __func__, "path_has_component(\"%s\", \".git\") returned false: expected true", relpath);
        not_reached();
    } else {
    ...
    if (relpath != NULL) {
        ...
        if (stat(relpath, &in_st) != 0) {
            errp(108, __func__, "couldn't stat file %s", relpath);
            not_reached();
        }
        ...
        if (stat("test_file_util.copy.c", &out_st) != 0) {
            errp(109, __func__, "couldn't stat file test_file_util.copy.c");
            not_reached();
        }

        if (!is_mode("test_file_util.copy.c", in_st.st_mode)) {
            err(110, __func__, "copyfile() failed to copy st_mode of file %s", relpath);
            not_reached();
        } else {
        ...
        if (unlink("test_file_util.copy.c") != 0) {
            errp(111, __func__, "unable to delete file test_file_util.copy.c");
            not_reached();
        } else {
        ...
        if (!is_empty("test_file_util.copy.c")) {
            errp(112, __func__, "just deleted file test_file_util.copy.c is not empty");
            not_reached();
        }
    ...
    if (relpath != NULL) {
        ...
        errno = 0;  /* pre-clear errno for errp() */
        if (stat("test_file_util.copy.c", &out_st) != 0) {
            errp(113, __func__, "failed to stat test_file_util.copy.c");
            not_reached();
        }
        if ((out_st.st_mode & (S_IRWXU | S_IRWXG | S_IRWXO)) != (S_IRUSR|S_IWUSR)) {
            err(114, __func__, "copyfile() failed to set S_IRUSR|S_IWUSR on test_file_util.copy.c");
            not_reached();
        } else {
    ...
    if (stat("test_ioccc/test_file_util.o", &in_st) != 0) {
        errp(117, __func__, "failed to stat test_ioccc/test_file_util.o");
        not_reached();
    }
    ...
    if (stat("test_file_util.copy.o", &out_st) != 0) {
        errp(118, __func__, "failed to stat test_file_util.copy.o");
        not_reached();
    }

    if (!is_mode("test_file_util.copy.o", in_st.st_mode)) {
        err(119, __func__, "test_file_util.o st_mode != test_file_util.copy.o st_mode: %04o != %04o",
                in_st.st_mode & ~S_IFMT, out_st.st_mode & ~S_IFMT);
        not_reached();
    } else {
    ...
    if (size1 <= 0 || size1 != size2 || size1 != in_st.st_size || size1 != out_st.st_size) {
        err(120, __func__, "size_if_file(\"file_util.o\") != size_if_file(\"test_file_util.copy.o\") or <= or != stat(2) st_size!");
        not_reached();
    } else {
    ...
    if (unlink("test_file_util.copy.o") != 0) {
        errp(121, __func__, "unable to delete file test_file_util.copy.o");
        not_reached();
    } else {
        fdbg(stderr, DBG_MED, "successfully deleted copied file test_file_util.copy.c");
    }
    ...
    if (!is_empty("test_file_util.copy.o")) {
        errp(122, __func__, "just deleted file test_file_util.copy.o is not empty");
        not_reached();
    }
    ...
    if (!exists(relpath)) {
        err(123, __func__, "%s does not exist", relpath);
        not_reached();
    } else if (!is_dir(relpath)) {
        err(124, __func__, "%s is not a directory", relpath);
        not_reached();
    } else {
    ...
    if (!dir_exists) {
        if (!is_mode(relpath, 0755)) {
            err(125, __func__, "failed to set mode of %s to %o", relpath, 0755);
            not_reached();
        } else {
    ...
    if (!dir_exists) {
        ...
        if (!has_mode(relpath, 0755)){
            err(130, __func__, "%s does not have bits %o set", relpath, 0755);
            not_reached();
        } else {
        ...
        if (!has_mode(relpath, S_IRWXU)) {
            err(131, __func__, "%s does not have bits %o set", relpath, S_IRWXU);
            not_reached();
        } else {
        ...
        if (has_mode(relpath, S_ISUID)) {
            err(132, __func__, "%s has set user id on execution", relpath);
            not_reached();
        } else {
    ...
    if (ent == NULL) {
        err(133, __func__, "read_fts() returned a NULL pointer on \"test_ioccc\"");
        not_reached();
    } else {
        do {
            char *p = fts_path(ent);
            ...
            switch (ent->fts_info) {
                case FTS_F:
                    ...
                    if (is_file(p)) {
                        ...
                        err(135, __func__, "%s reported as FTS_FILE !is_file(\"%s\")", p, p);
                        not_reached();
                    }
                    break;
                case FTS_D:
                    ...
                    if (is_dir(p)) {
                        ...
                        err(136, __func__, "%s reported as FTS_D !is_dir(\"%s\")", p, p);
                        not_reached();
                    }
                    break;
                case FTS_SL:
                    ...
                    if (is_symlink(p)) {
                        ...
                        err(137, __func__, "%s reported as FTS_SL !is_symlink(\"%s\")", p, p);
                        not_reached();
                    }
                    break;
                case FTS_SLNONE:
                    ...
                    break;
                case FTS_NS:
                    err(138, __func__, "no stat(2) info available for path %s in tree", p);
                    not_reached();
                    break;
                case FTS_NSOK:
                    err(139, __func__, "encountered FTS_NSOK for path %s in tree: FTS_NOSTAT set!", p);
                    not_reached();
                    break;
            }
    ...
    ent = read_fts("test_ioccc", -1, &cwd, &fts);
    if (ent == NULL) {
        err(140, __func__, "read_fts() returned a NULL pointer on \"test_ioccc\" for directories");
        not_reached();
    } else {
        do {
            char *p = fts_path(ent);
            if (p == NULL) {
                err(141, __func__, "fts_path(ent) returned NULL");
                not_reached();
            }
            if (ent->fts_info != FTS_D && ent->fts_info != FTS_DP) {
                err(142, __func__, "%s is not a directory", p);
                not_reached();
            } else {
    ...
    if (ent == NULL) {
        err(143, __func__, "read_fts() returned a NULL pointer on \".\" for directories");
        not_reached();
    } else {
        do {
            char *p = fts_path(ent);
            ...
            if (ent->fts_info != FTS_F) {
                err(145, __func__, "%s is not a file", p);
                not_reached();
            } else if (!strncmp(p, "test",4)) {
                err(146, __func__, "found file meant to be ignored: %s", p);
                not_reached();
            } else {
    ...
    if (ent == NULL) {
        ...
        do {
            ...
            if (ent->fts_info != FTS_F) {
                ...
                err(150, __func__, "found file that should not have matched: %s", p);
                not_reached();
            } else {
    ...
    ent = read_fts("test_ioccc", -1, &cwd, &fts);
    if (ent == NULL) {
        err(151, __func__, "read_fts() returned a NULL pointer on \"test_ioccc\"");
        not_reached();
    } else {
        do {
            char *p = fts_path(ent);
            ...
            switch (ent->fts_info) {
                ...
                case FTS_SLNONE:
                    ...
                    break;
                case FTS_NS:
                    err(153, __func__, "no stat(2) info available");
                    not_reached();
                    break;
                case FTS_NSOK:
                    err(154, __func__, "encountered FTS_NSOK for path %s in tree: FTS_NOSTAT set!", p);
                    not_reached();
                    break;
            }
        } while ((ent = read_fts(NULL, -1, &cwd, &fts)) != NULL);
    ...
    if (fname == NULL) {
        err(155, __func__, "unable to find directory \"bad\"");
        not_reached();
    } else {
    ...
    fname = find_path("bad", NULL, -1, &cwd, false, &fts);
    if (fname != NULL) {
        err(156, __func__, "found ignored directory \"bad\"");
        not_reached();
    } else {
        fdbg(stderr, DBG_MED, "successfully ignored directories in ignore list");
    }
    ...
    if (paths_found != NULL) {
        err(157, __func__, "found paths when none should have been found");
        not_reached();
    }
    ...
    if (paths_found != NULL) {
        err(158, __func__, "found paths when none should have been found");
        not_reached();
    }
    ...
    if (paths_found == NULL) {
        err(159, __func__, "didn't find any paths in the paths array");
        not_reached();
    }
    ...
    if (name == NULL) {
         ...
         */
        err(160, __func__, "didn't find \"test_ioccc\" in paths array");
        not_reached();
    } else {
    ...
    if (len > 0) {
        for (j = 0; j < len; ++j) {
            ...
            if (name == NULL) {	/* paranoia */
                err(161, __func__, "found NULL pointer at paths_found[%ju]", (uintmax_t)j);
                not_reached();
            }
    ...
    if (paths_found == NULL) {
        ...
        for (j = 0; j < len; ++j) {
            ...
            if (u == NULL) {
                err(163, __func__, "NULL found in paths_found[%ju]", (uintmax_t)j);
                not_reached();
            }
        }
    }
    ...
    paths_found = find_paths(paths, NULL, -1, &cwd, false, &fts);
    if (paths_found == NULL) {
        err(168, __func__, "didn't find any files in the paths array");
        not_reached();
    }
    ...
    paths_found = find_paths(paths, NULL, -1, &cwd, false, &fts);
    if (paths_found != NULL) {
        err(172, __func__, "found paths when none should have been found");
        not_reached();
    }
    ...
    paths_found = find_paths(paths, NULL, -1, &cwd, false, &fts);
    if (paths_found == NULL) {
        err(173, __func__, "unable to find any path in the directory");
        not_reached();
    }
    ...
    paths_found = find_paths(paths, "test_ioccc", -1, &cwd, false, &fts);
    if (paths_found == NULL) {
        err(174, __func__, "didn't find any paths in the paths array");
        not_reached();
    }
    ...
    paths_found = find_paths(paths, "test_ioccc", -1, &cwd, false, &fts);
    if (paths_found != NULL) {
        err(182, __func__, "bogus range of min/max directories found directories");
        not_reached();
    }
    ...
    paths_found = find_paths(paths, "test_ioccc", -1, &cwd, false, &fts);
    if (paths_found != NULL) {
        err(183, __func__, "found unexpected socket under test_ioccc/");
        not_reached();
    }
    ...
    paths_found = find_paths(paths, "test_ioccc", -1, &cwd, false, &fts);
    if (paths_found != NULL) {
        err(184, __func__, "found unexpected character device under test_ioccc/");
        not_reached();
    }
    ...
    paths_found = find_paths(paths, "test_ioccc", -1, &cwd, false, &fts);
    if (paths_found != NULL) {
        err(185, __func__, "found unexpected block device under test_ioccc/");
        not_reached();
    }
    ...
    paths_found = find_paths(paths, "test_ioccc", -1, &cwd, false, &fts);
    if (paths_found != NULL) {
        err(186, __func__, "found unexpected FIFO under test_ioccc/");
        not_reached();
    }
    ...
    if (paths_found != NULL) {
        ...
        for (j = 0; j < len; ++j) {
            name = dyn_array_value(paths_found, char *, j);
            if (name == NULL) {
                err(187, __func__, "found NULL pointer in paths_found (not file, directory or symlink) array");
                not_reached();
            }
         ...
         * make it an error
         */
        err(188, __func__, "found unexpected file type under test_ioccc/");
        not_reached();
    }
    ...
    if (!exists(relpath)) {
        err(189, __func__, "file %s does not exist after touch()", relpath);
        not_reached();
    }
    ...
    if (paths_found != NULL) {
        ...
        for (j = 0; j < len; ++j) {
            name = dyn_array_value(paths_found, char *, j);
            if (name == NULL) {
                err(190, __func__, "found NULL pointer in paths_found (any) array");
                not_reached();
            }
            if (strcmp(relpath, name) != 0) {
                err(191, __func__, "found non-matching file in list: %s != %s", name, relpath);
                not_reached();
            }
            fdbg(stderr, DBG_MED, "found file %s as case-sensitive search", name);
        }
    } else {
        err(192, __func__, "couldn't find any file called \"%s\" as case-sensitive search", relpath);
        not_reached();
    }
    ...
    if (paths_found != NULL) {
        ...
        err(195, __func__, "couldn't find any file called \"%s\" by case-insensitive search", relpath);
        not_reached();
    }
    ...
    if (unlink(relpath) != 0) {
        if (errno != ENOENT) {
            errp(196, __func__, "unable to delete file %s", relpath);
            not_reached();
        }
    } else {
     ...
     */
    if (!is_empty(relpath)) {
        errp(197, __func__, "just deleted file %s is not empty", relpath);
        not_reached();
    }
     ...
     */
    if (!exists(relpath)) {
        err(198, __func__, "file %s does not exist", relpath);
        not_reached();
    }
    ...
    if (paths_found != NULL) {
        ...
        for (j = 0; j < len; ++j) {
            name = dyn_array_value(paths_found, char *, j);
            if (name == NULL) {
                err(199, __func__, "found NULL pointer in paths_found (any) array");
                not_reached();
            }
            fdbg(stderr, DBG_MED, "found file %s as case-sensitive search", name);
        }
    ...
    if (paths_found != NULL) {
        ...
        for (j = 0; j < len; ++j) {
            name = dyn_array_value(paths_found, char *, j);
            if (name == NULL) {
                err(200, __func__, "found NULL pointer in paths_found array");
                not_reached();
            }
            if (strcasecmp(relpath, name) != 0) {
                err(201, __func__, "found non-matching file: %s != %s", name, relpath);
                not_reached();
            }
            fdbg(stderr, DBG_MED, "found %s by case-insensitive search", name);
        }
         ...
         */
        err(202, __func__, "couldn't find any file called %s by case-insensitive search", relpath);
        not_reached();
    }
    ...
    if (fname != NULL) {
        ...
        err(203, __func__, "couldn't find %s in tree", relpath);
        not_reached();
    }
    ...
    if (unlink(relpath) != 0) {
        if (errno != ENOENT) {
            errp(204, __func__, "unable to delete file %s", relpath);
            not_reached();
        }
    } else {
        fdbg(stderr, DBG_MED, "successfully deleted created file %s", relpath);
     ...
     */
    if (!is_empty(relpath)) {
        errp(205, __func__, "just deleted file %s is not empty", relpath);
        not_reached();
    }
